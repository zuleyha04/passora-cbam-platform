...
export default function Simulation() {
  ...
  return (
    <div className="flex flex-col gap-5 p-6 max-w-6xl animate-fade-in">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900">⟳ Tedarikçi Simülasyonu</h1>
      ...
      <div className="grid grid-cols-[360px_1fr] gap-5 items-start">
        ...
        <div className="flex flex-col gap-4">
          <div className="card">
            <div className="flex items-center justify-between mb-4">
              <div className="text-xs font-bold text-slate-600 uppercase tracking-wider">⚙️ Tedarikçi Karma Ayarı</div>
            ...
            {afterSuppliers.map((s, i) => {
              ...
              return (
                <div key={i} className="bg-surface-2 border border-black/[0.08] rounded-xl p-4 mb-3">
                  ...
                  <div className="flex flex-col gap-1 mb-2">
                    <div className="flex justify-between text-xs text-slate-600">
                      <span>Pay</span><strong className="text-slate-800">{s.share.toFixed(0)}%</strong>
                    </div>
                  ...
                  <div className="text-xs text-slate-500">
                    Emisyon: <span className="font-mono text-slate-700">{emission.toFixed(2)} tCO₂e</span>
                    {' · '}
                    <span className="font-mono text-slate-700">{formatEur(emission * etsPrice)}</span>
                  </div>
                </div>
              );
            })}
          ...
          {/* EF Reference */}
          <div className="card">
            <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-3">📊 AB CBAM Benchmark EF</div>
            {[
              ...
              <div key={i} className="flex items-center gap-2 py-2 border-b border-black/[0.06] last:border-0 text-xs text-slate-600">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Chart */}
          <div className="card">
            <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-3">📊 Maliyet Karşılaştırması</div>
          ...
          <div className="card">
            <div className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-3">🏭 Ağırlıklı Emisyon Detayı</div>
              ...
              {[
                ...
                <div key={si}>
                  ...
                  {scenario.list.map((s, i) => (
                    <div key={i} className="flex items-center gap-2 py-1.5 border-b border-black/[0.06] last:border-0 text-xs text-slate-600">
